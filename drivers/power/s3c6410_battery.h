...
#define BATT_CRITICAL		(150) /* 3.6037V default: 8 */ 	//(74)	/* 3.707V */
#define BATT_MINIMUM		(-300) /* 3.554V default: -28 */	//(38)	/* 3.655V */
#define BATT_OFF		(-400) /* 3.4029V default: -128 */	//(-103)	/* 3.45V  */
...
#define TOTAL_CHARGING_TIME	(24*60*60*1000)	/* 6 hours */
#define TOTAL_RECHARGING_TIME	(24*60*60*1000)	/* 2 hours */

#ifdef __BATTERY_COMPENSATION__
#define COMPENSATE_VIBRATOR		19 //default 19
#define COMPENSATE_CAMERA		40 //default 25
#define COMPENSATE_MP3			25 //default 17
#define COMPENSATE_VIDEO		50 //default 28
#define COMPENSATE_VOICE_CALL_2G	18 //default 13
#define COMPENSATE_VOICE_CALL_3G	20 //default 14
#define COMPENSATE_DATA_CALL		35 //default 25
#define COMPENSATE_LCD			5 //default 0
